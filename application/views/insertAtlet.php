                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="id">
                                    <p>ID Athlete</p>
                                    <input type="text" name="" id="idatlet" placeholder="ID Athlete">
                                </div>
                                <div class="uname">
                                    <p>Name</p>
                                    <input type="text" name="" id="name" placeholder="Athlete name">
                                </div>
                                <div class="phone">
                                    <p>Phone Number</p>
                                    <input type="text" name="" id="phone" placeholder="+62xxxxxxx">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="gen">
